          ...
          child: Scaffold(
            ...
            appBar: CustomAppBar(
              leading: CustomIconButton(
                ...
                onTap: () {
                  if (userController.isLoginLoading) return;

                  AppRouter.pop();
                },
              ),
            ),
            body: userController.isLoginLoading
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: CustomInput(
                                title: "Password",
                                hint: '*********',
                                controller: userController.passwordCtrl,
                                isPassword: true,
                                onChanged: (value) {
                                  userController.setStatus();
                                },
            ...
            bottomNavigationBar: userController.isLoginLoading
                ? null
                : Padding(
                    padding: const EdgeInsets.only(
                      top: Spaces.x2,
                    ...
                    child: Column(
                      ...
                      children: [
                        PrimaryButton(
                          disable: !userController.buttonLoginEnable,
                          text: "Log In",
                          onTap: () async {
